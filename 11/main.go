...
import (
	...
	"github.com/gust1n/advent-of-code-2019/intcode"
)
...
func main() {
	...
	icc := intcode.NewComputer(program)
...
// returns new x, y
func step(grid [100][100]int, x int, y int, dir direction) (int, int) {
	fmt.Printf("stepping from [%d, %d] in direction '%s'\n", x, y, dir)
